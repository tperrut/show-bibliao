var questions = [
  ...
  {
    points: 30,
    question: "Qual apóstolo de Jesus era médico?",
    options: [
  ...
  {
    points: 500,
    question: "Quem foi o apóstolo conhecido como \"o incrédulo\"?",
    options: [
  ...
  {
    points: 900,
    question: "O que significa o nome Boanerges, dado por Jesus a Tiago e a João?",
    options: [
  ...
  {
    points: 1000,
    question: "Quem substituiu Judas Iscariotes como apóstolo?",
    options: [
